  ...
  <body>
    <div id="wrapper">
      <header>
        ...
        <h2>DanDomain A/S - Alsikevej 31 - DK-8920 Randers NV - Tlf: (+45) 87 77 90 45 - <a href="mailto:info@dandomain.dk?Subject=Contact%20from%20https://sslgen.dandomain.dk" target="_top">info@dandomain.dk</a></h2>
...
<form id="uploadform" action="upload.php" method="POST" enctype="multipart/form-data">
  <ol>
    <li>
      ...
      <select name="pendingCert" form="uploadform" id="pendingCertDropdown">
      <?php
       while ($stmt->fetch()) {
